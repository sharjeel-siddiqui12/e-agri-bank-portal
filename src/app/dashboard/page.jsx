    ...
    <div className={styles.container}>
      ...
      <div className={styles.statsGrid}>
        <Card className={styles.statCard}>
          <div className={styles.statContent}>
            <div className={styles.iconWrapper}>
              <span className={`${styles.statIcon} ${styles.cropIcon}`}>🌱</span>
            </div>
            <div>
        ...
        <Card className={styles.statCard}>
          <div className={styles.statContent}>
            <div className={styles.iconWrapper}>
              <span className={`${styles.statIcon} ${styles.moneyIcon}`}>💰</span>
            </div>
            <div>
        ...
        <Card className={styles.statCard}>
          <div className={styles.statContent}>
            <div className={styles.iconWrapper}>
              <span className={`${styles.statIcon} ${styles.userIcon}`}>👥</span>
            </div>
            <div>
        ...
        <Card className={styles.statCard}>
          <div className={styles.statContent}>
            <div className={styles.iconWrapper}>
              <span className={`${styles.statIcon} ${styles.overdueIcon}`}>📅</span>
            </div>
            <div>
        ...
        <Card className={styles.statCard}>
          <div className={styles.statContent}>
            <div className={styles.iconWrapper}>
              <span className={`${styles.statIcon} ${styles.settledIcon}`}>✓</span>
            </div>
            <div>
        ...
        <Card className={styles.statCard}>
          <div className={styles.statContent}>
            <div className={styles.iconWrapper}>
              <span className={`${styles.statIcon} ${styles.nplIcon}`}>📊</span>
            </div>
            <div>
