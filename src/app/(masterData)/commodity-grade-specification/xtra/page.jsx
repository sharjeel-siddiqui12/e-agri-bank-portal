        ...
        <div className={styles.gridRow}>
          ...
          <div className={styles.formRow}>
            ...
            <Select
              ...
              onValueChange={(value) =>
                setFormData((prev) => ({ ...prev, commodityGrade: value }))
              }
            >
              <SelectTrigger className={styles.input}>
        ...
        <div className={styles.gridRow}>
          <div className={styles.formRow}>
            ...
            <Select
              ...
              onValueChange={(value) =>
                setFormData((prev) => ({ ...prev, gradingParameter: value }))
              }
            >
              <SelectTrigger className={styles.input}>
              ...
              <SelectContent>
                {gradingParameterOptions.map((opt) => (
                  <SelectItem key={opt.value} value={opt.value}>
                    {opt.label}
                  </SelectItem>
                ))}
            ...
            <div className={styles.radioRow}>
              ...
              >
                <div className={styles.radioItem}>
                  ...
                  />
                  <Label htmlFor="mandatory-yes" className={styles.radioLabel}>
                    Yes
                  </Label>
                </div>
                <div className={styles.radioItem}>
