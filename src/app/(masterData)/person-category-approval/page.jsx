...
import styles from "./PersonCategoryApproval.module.css";
...
export default function PersonCategoryApprovalPage() {
  ...
  return (
    <div className={styles.page}>
      <h1 className={styles.heading}>Person Category Setup (Approval)</h1>
